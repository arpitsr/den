...
| `PIT_PROXY_POLICY` | YAML egress policy file (`allow:`/`deny:` host lists, exact or subdomain, deny wins; merged over the defaults, re-read live). Schema example: `src/default-egress.yaml` |
