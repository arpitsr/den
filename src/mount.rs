...
impl FileSystem for MutexFsAdapter {
    async fn lookup(
        ...
        parent_ino: i64,
        name: &str,
    ) -> Result<Option<Stats>, agentfs_sdk::error::Error> {
    ...
    async fn readdir_plus(
        &self,
        ino: i64,
    ) -> Result<Option<Vec<agentfs_sdk::DirEntry>>, agentfs_sdk::error::Error> {
    ...
    async fn chown(
        ...
        uid: Option<u32>,
        gid: Option<u32>,
    ) -> Result<(), agentfs_sdk::error::Error> {
    ...
    async fn open(
        ...
        ino: i64,
        flags: i32,
    ) -> Result<agentfs_sdk::BoxedFile, agentfs_sdk::error::Error> {
    ...
    async fn mkdir(
        ...
        uid: u32,
        gid: u32,
    ) -> Result<Stats, agentfs_sdk::error::Error> {
        self.inner
            .lock()
            .await
    ...
    async fn create_file(
        ...
        uid: u32,
        gid: u32,
    ) -> Result<(Stats, agentfs_sdk::BoxedFile), agentfs_sdk::error::Error> {
        self.inner
            .lock()
            .await
